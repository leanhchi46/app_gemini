...
def save_md_report(app: "AppUI", text: str, cfg: "RunConfig") -> "Path":
    """
    ...
    try:
        ...
        logger.exception(f"Lỗi khi ghi báo cáo Markdown vào {out.name}: {e}")
        return None
...
__all__ = ["save_md_report", "extract_human_readable_report"]
